        ...
        <div className="mb-2 flex flex-col lg:flex-row mt-6 items-start justify-between w-full">
          ...
          <div className="w-full lg:w-1/2 ml-4 lg:ml-0">
            <p className="text-md mt-4 font-semibold text-Graytext">
              Container Stuffing<p> Container stuffing requires technical knowledge regarding weight and volume, as well as the distribution of goods in a way that ensures good use of space, correct shipping and in a profitable manner for the customer.
              Container Unloading
            </p></p>
